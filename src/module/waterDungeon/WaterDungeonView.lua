...
function UIWaterDungeon:ShowTimeRest()
	...
	objSwf.costItem.htmlLabel = string.format( "<font color='#ffffff'>Trở thành kim cương VIP khi tiêu tốn<font color='%s'><u>%s</u></font>Tiến vào</font>", itemColor, itemName)
