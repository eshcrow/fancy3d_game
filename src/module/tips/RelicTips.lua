...
function RelicTips:GetTitleTwo()
	...
	str = str .. self:GetHtmlText("Cấp tinh luyện hiện tại" .. "+" .. t_newequip[param1].lv,"#00ff00",TipsConsts.Default_Size)
	str = str .. "</textformat>";
	return str;
end
...
function RelicTips:GetBaseAttr()
	...
	str = str .. self:GetHtmlText("Tinh luyện thuộc tính:",TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
