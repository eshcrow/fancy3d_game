...
function NewTianshenTips:GetTianshenAttr()
	...
	str = str .. self:GetHtmlText("Tinh cấp" .. self:GetStar(self.tipsVO.tianshen:GetStar(), self.tipsVO.tianshen:GetMaxStar()),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	...
	--资质
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Tư chất " .. self:GetHtmlText(self.tipsVO.tianshen:GetZizhi(), TipsConsts:GetItemQualityColor(self.tipsVO.tianshen:GetShowQuality()), TipsConsts.TitleSize_Three, false),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
	--等级
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Đẳng cấp " .. self:GetHtmlText(self.tipsVO.tianshen:GetLv(), "#ffffff", TipsConsts.TitleSize_Three, false),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
	--@二级标签
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Thiên thần thuộc tính:",TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
	...
	str = str .. self:GetHtmlText("Lực chiến:" .. self:GetHtmlText(PublicUtil:GetFigthValue(list), "#ffff00", TipsConsts.TitleSize_Three),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
...
function NewTianshenTips:GetCardAttr()
	...
	--秒睡
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Sau khi sử dụng có thể nhận được Thiên Thần " .. self:GetHtmlText(NewTianshenUtil:GetTianshenName(self.tipsVO.id) , 
	...
	if star and star > 0 then
		str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
		str = str .. self:GetHtmlText("Tinh cấp" .. self:GetStar(star, NewTianshenUtil:GetAttrXishuCfg(NewTianshenUtil:GetQualityByZizhi(zizhi)).maxstar),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
		str = str .. "</p></textformat>";
		str = str .."<textformat></br>".."<br></textformat>"
		str = str .. self:GetVGap(5);
		str = str .. "</font></textformat>";
	...
	str = str .. self:GetHtmlText("Tư chất " .. self:GetHtmlText(zizhiStr, TipsConsts:GetItemQualityColor(NewTianshenUtil:GetShowQuality(zizhi)), 
	...
	if lv and lv > 0 then
		str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
		str = str .. self:GetHtmlText("Đẳng cấp " .. self:GetHtmlText(lv, "#ffffff", TipsConsts.TitleSize_Three, false),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
		str = str .. "</p></textformat>";
		str = str .."<textformat></br>".."<br></textformat>"
		str = str .. self:GetVGap(5);
		str = str .. "</font></textformat>";
	...
	--@二级标签
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Thuộc tính ban đầu:",TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
	...
	--@初始战力
	str = str .. "<textformat leading='-40' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Lực chiến ban đầu:" .. self:GetHtmlText(PublicUtil:GetFigthValue(list), "#ffff00", TipsConsts.TitleSize_Three),TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
...
function NewTianshenTips:GetEffect()
	...
	--资质
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Kỹ năng chủ động:",TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
...
function NewTianshenTips:GetPassEffect()
	...
	--资质
	str = str .. "<textformat leading='-25' leftmargin='6'><p>"; 
	str = str .. self:GetHtmlText("Kỹ năng bị động:",TipsConsts.TwoTitleColor,TipsConsts.TitleSize_Three);
	str = str .. "</p></textformat>";
	str = str .."<textformat></br>".."<br></textformat>"
	str = str .. self:GetVGap(5);
	str = str .. "</font></textformat>";
