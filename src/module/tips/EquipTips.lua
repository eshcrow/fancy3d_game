	...
	for i = 1, qualityConfig.num do
		...
		if info then
			...
			if isHaveWash then
				...
				str = str .. "</p></textformat>";
				str = str .. "<textformat leading='5' leftmargin='23'><p>"; 
				str = str .. self:GetHtmlText(StrConfig['tips1336'],"#5a5a5a",TipsConsts.Default_Size,false);  --Chưa kích hoạt
				str = str .. "</p></textformat>";
			end
		end
	end
