...
function BossMedalController:OnBossMedalInfo( msg )
	QuestController:TestTrace("Quay lại Boss huy hiệu, Trên đường dây")
...
function BossMedalController:OnBossMedalLevelUp( msg )
	QuestController:TestTrace("Trở lại Boss Huy chương nâng cấp kết quả" .. msg.result)
	QuestController:TestTrace(msg)
	---------------------------------------------
...
function BossMedalController:OnBossMedalPointsRsv( msg )
	QuestController:TestTrace("Quay lại điểm huy chương Boss")
	QuestController:TestTrace(msg)
	---------------------------------------------
...
function BossMedalController:ReqLevelUp(auto)
	...
	---------------------------------------------
	QuestController:TestTrace("Yêu cầu nâng cấp/Kích hoạt huy chương Boss")
end
