...
function LingJueController:OnLingJueInfoRcv(msg)
	---[[
	QuestController:TestTrace("Tin tức Linh Quyết")
...
function LingJueController:OnLingJueLevelUp(msg)
	---[[
	QuestController:TestTrace("Nâng cấp Linh Quyết lại(Kích hoạt/Lĩnh hội)")
	QuestController:TestTrace(msg)
	--]]
...
function LingJueController:ReqLingJueLevelUp(tid)
	...
	MsgManager:Send(msg)
	---[[
	QuestController:TestTrace("Yêu cầu nâng cấp Linh Quyết(Kích hoạt/Lĩnh hội)")
	QuestController:TestTrace(msg)
	--]]
end
