...
function UIInterServiceBossStory2:OnBuffItemOver(buffType)
	...
	str = str .. '<font color="#dcdcdc" size="14">Sau khi chiếm lĩnh thủ vệ, các thành viên có thể đạt thuộc tính tăng thêm' ..'</font><br/>'
	if statueList and statueList[buffType] then
		...
		if statueList[buffType].groupid == sid then
			str = str .. '<font size = "14" color="#2FE00D">Hiện tại đã chiếm linh, chọn tiến về</font>'
		else
			str = str .. '<font size = "14" color="#CC0000">Hiện tại chưa chiếm linh, chọn tiến về</font>'
		end
	end
	str = str .. '</textformat>'
