...
function UIUnionDiGongZhuiZongView:ShowInfo()
	...
	--柱子
	objSwf.btnZhuZi1.htmlLabel = string.format( StrConfig["unionDiGong002"],"Di tích thủ hộ(Trái)");
	objSwf.btnZhuZi2.htmlLabel = string.format( StrConfig["unionDiGong002"],"Di tích thủ hộ(Phải)");
	objSwf.btnZhuZi1.rollOver = function()
									TipsManager:ShowBtnTips("Chiếm lĩnh di tích thủ hộ được công kích+5%, phòng ngự+5%, sinh mệnh+5% thêm");
								end
