...
function UINewTianshenStarUp:ShowTianshenInfo()
	...
	objSwf.txt_curStar.text = tianshen:GetStar() .."Tinh"
	...
	if tianshen:IsMaxStar() then
		for i = 1, 7 do
			objSwf['txt_pro' .. (i+10)].htmlText = "<font color='#00ff00'>Đã đạt tối đa</font>"
		end
		objSwf.txt_nextStar.htmlText = "<font color='#00ff00'>Đã đạt tối đa</font>"
		objSwf.txt_nextfight.htmlText = "<font color='#00ff00'>Đã đạt tối đa</font>"
		...
		objSwf.txt_nextStar.text = (tianshen:GetStar() + 1) .. "Tinh"
