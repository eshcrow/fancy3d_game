...
function UIOperactivitesExchangeSpecial:UpdateUI()
	...
	objSwf.txtCost1.text = "Tiêu hao:" .. cost[2] .. "Nguyên bảo"
	if not actList[2] then
		...
		objSwf.txtLabel1.text = "Gói quà hoàng kim"
		objSwf.txtLabel2.text = "Gói quà kim cương"
		...
		objSwf.txtCost2.text = "Tiêu hao:" .. cost[2] .. "Nguyên bảo"
	end
