...
function UISkillBasic:ShowSkillLearn()
	...
	panel.tfSkillInfo.htmlText = "";  --未学习的0Cấp技能在下级技能效果描述栏中不显示下级技能效果，为空；
...
function UISkillBasic:ShowSkillLvlUp()
	...
	panel.tfLvl.htmlText = string.format(StrConfig['skill102'],cfg.level,maxLvl);   ---%s/%sCấp
	--title
