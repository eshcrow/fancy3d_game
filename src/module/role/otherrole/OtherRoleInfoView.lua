...
local s_roleInfo = {"Tên：","Cấp：","Kết Bái：","Vinh Dự：","Bang Cống：","Trị PK：","Công Huân：","Uy Tín：","Vợ / chồng：",};
...
function UIOtherRoleInfo:ShowProInfo()
	...
	for i = 1, 4 do
		...
		btn.rollOver = function() TipsManager:ShowTips(TipsConsts.Type_Normal, PublicAttrConfig.TipsStr[proStr] or "Thuộc tính TIPS Chưa đầy", TipsConsts.ShowType_Normal, TipsConsts.Dir_RightDown) end
