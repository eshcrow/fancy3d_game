...
function UILoadingScene:ShowTxts(  )
	self.txts = {'Carregando modelo de recursos ','Carregando imagens de origem','Carregando textura','Carregando recursos de efeitos','Entrando no jogo'};
	self.txtss = {{'Carregando modelo montado','Carregando montagem da câmera','Carregando modelo de pacote'},
	{'Estrutura de carregamento','Carregando cena','Carregando áudio','Download de mapas','Carregando detalhes','Carregando animação'},
	{'Carregando mapa','Carregando mapa','Carregando detalhes','Carregando'},
	{'Carregando NPC','Carregando Efeitos','Carregando efeitos'},
	{'Atualizando detalhes','Atualizando interface do jogo','Atualizando'}};
