...
function UIDungeonMain:InitPageState( )
	...
	if funcOpen then
		...
		objSwf.btnjingyanfubenAdd.rollOver = function() TipsManager:ShowBtnTips(string.format('<font color="#ff0000">%s Cấp mở ra</font>',Openlv)) end
	...
	if funcOpen then
		...
		objSwf.btnzuduijingyanAdd.rollOver = function() TipsManager:ShowBtnTips(string.format('<font color="#ff0000">%s Cấp mở ra</font>',Openlv)) end
	...
	if curRoleLvl >= openLevel then
		...
		objSwf.btndanrenpataAdd.rollOver = function() TipsManager:ShowBtnTips(cfg.open_level .. " Cấp mở ra") end
	...
	if funcOpen then
		...
		objSwf.btnzhuxianzhenAdd.rollOver     = function() TipsManager:ShowBtnTips(string.format('<font color="#ff0000">%s Cấp mở ra</font>',Openlv)) end
	...
	if funcOpen then
		...
		objSwf.btnzuduifubenAdd.rollOver = function() TipsManager:ShowBtnTips(string.format('<font color="#ff0000">%s Cấp mở ra</font>',Openlv)) end
	...
	if funcOpen then
		...
		objSwf.btnmuyezhizhanfubenAdd.rollOver    = function() TipsManager:ShowBtnTips(string.format('<font color="#ff0000">%s Cấp mở ra</font>',Openlv)) end
